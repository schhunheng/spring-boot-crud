...
public class JdbcTutorialRepository implements TutorialRepository {
    ...
    public List<Tutorial> findAll() {
        List<Tutorial> tutorials = jdbcTemplate.query("SELECT * from tutorials",
    ...
    public int save(Tutorial tutorial) {
        ...
        return jdbcTemplate.update("INSERT INTO tutorials (title,description,published) VALUES(?,?,?)", new Object[] {
                tutorial.getTitle(),
